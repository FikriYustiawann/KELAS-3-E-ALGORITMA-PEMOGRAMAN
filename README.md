...
## **Input-Proses-Output**
## Input
Nilai ujian matematika yang diperoleh siswa.

## Proses
Program membandingkan nilai siswa dengan batas nilai 75.

* Jika nilai kurang dari 75, siswa perlu mengikuti remedial.
* Jika nilai 75 atau lebih, siswa tidak perlu mengikuti remedial.

## Output
Keterangan apakah siswa perlu mengikuti remedial atau tidak.
